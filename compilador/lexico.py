CONSTANTES = ('BOOL', 'CALL','CHAR', 'CONST_CHAR', 'CONST_STRING', 'DIF', 'DO',
    ...
    'VOID', 'WHILE', 'WRITE', 'FALSE', 'TRUE', 'COM', 'MULTI')
    ...
    def siguiente_componente_lexico(self):
        ...
        while True:
            if self.estado == 0:
                ...
                self.__retrocede_indice()
                return Simbolo(token=TOKENS['COM'], lexema=self.__leer_lexema())
                ...
                return Simbolo(token=TOKENS['MULTI'], lexema=self.__leer_lexema())
